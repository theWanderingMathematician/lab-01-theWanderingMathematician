...
-   The `datasaurus_dozen` file has 1846 rows and 3 variables: **dataset**, **x**, and **y**.
...
-   The correlation coefficient between `x` and `y` for the `dino` dataset is -0.0645.
...
-   The `r2` value of the `star` dataset is greater than the `r` value of the `dino` dataset by 0.0015.
...
```{r}
circle_data %>%
  summarize(r3 = cor(x, y))
```

-   The `r3` value of the `circle` dataset is 0.0038 smaller than the `r` value of the `dino` dataset.
